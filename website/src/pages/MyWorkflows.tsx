      ...
      >
        ...
        >
          <Heart
            size={16}
            className={
              workflow.favorite ? "fill-red-500 text-red-500" : "text-gray-500"
            }
          />
        </Button>
...
const MyWorkflows = () => {
  ...
  const handleNewWorkflow = () => {
    // Create a new workflow directly without showing the input modal
    const workflowId = `wf-${Date.now()}`;

    // Create new workflow object with default values
    ...
    // Add the workflow to the context
  ...
  return (
    <main className="flex-grow pt-20">
            ...
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="favorites" className="mt-6">
                {filteredWorkflows.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-muted-foreground">
                      No favorite workflows found
                    </p>
                    <p className="text-sm mt-2">
                      Mark workflows as favorites by clicking the heart icon
                    </p>
                  </div>
                )}
              </TabsContent>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="max-w-md">
              ...
              <p className="text-muted-foreground mb-4">
                Discover pre-built workflow templates and AI agents to get
                started quickly
              </p>
              <Button
      ...
      {/* Input Modal for creating new workflow - will only be used if we re-enable the input prompt */}
      <InputModal
